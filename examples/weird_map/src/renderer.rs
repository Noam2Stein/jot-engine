...
pub struct RenderInput<'a, I: IntoIterator<Item = &'a Tilemap<10, Colored, Pos2D>>> {
    pub cam: Camera,
...
impl Renderer {
    ...
    pub fn render<'a, I: IntoIterator<Item = &'a Tilemap<10, Colored, Pos2D>>>(
        &self,
        input: RenderInput<'a, I>,
        output: &GpuTexture<2>,
        gpu: &Gpu,
    ) {
